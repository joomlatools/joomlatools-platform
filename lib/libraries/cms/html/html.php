						...
						else
						{
							...
							if (strpos($file, '/'))
							{
								...
								if (strpos($file, '/'))
								{
									...
									$path = JPATH_WEB . "/media/$extension/$element/$folder/$file";
									...
									$path = JPATH_WEB . "/media/$extension/$folder/$element/$file";
									...
									$path = JPATH_WEB . "/media/system/$folder/$element/$file";
								...
								else
								{
									...
									$path = JPATH_WEB . "/media/$extension/$folder/$file";
									...
									// Try to deal with system files in the media folder
									$path = JPATH_WEB . "/media/system/$folder/$file";
