...
class JInstallerAdapterTemplate extends JAdapterInstance
{
    ...
    public function loadLanguage($path = null)
    {
        ...
        if (!$source)
        {
            $this->parent
                ->setPath(
                    'source',
                    JPATH_WEB . ($this->parent->extension->client_id ? '/administrator' : '') . '/templates/' . $this->parent->extension->element
                );
        }
        ...
        $source = $path ? $path : JPATH_WEB . ($this->parent->extension->client_id ? '/administrator' : '') . '/templates/' . $name;
    ...
    public function uninstall($id)
    {
        ...
        $this->parent->setPath('extension_root', $client->web_root . '/templates/' . strtolower($name));
    ...
    {
        $results = array();
        $site_list = JFolder::folders(JPATH_WEB . '/templates');
        $admin_list = JFolder::folders(JPATH_WEB . '/administrator/templates');
    ...
    public function discover_install()
    {
        ...
        $manifestPath = $client->web_root . '/templates/' . $this->parent->extension->element . '/templateDetails.xml';
