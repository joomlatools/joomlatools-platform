...
<div class="modal hide fade" id="collapseModal">
    ...
    <div class="modal-footer">
        <button class="k-button k-button--default" type="button" onclick="document.id('batch-category-id').value='';document.id('batch-access').value='';document.id('batch-language-id').value=''" data-dismiss="modal">
            <?php echo JText::_('JCANCEL'); ?>
        </button>
        <button class="k-button k-button--primary" type="submit" onclick="Joomla.submitbutton('category.batch');">
