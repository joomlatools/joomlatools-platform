...
<div class="modal hide fade" id="collapseModal">
	...
	<div class="modal-body modal-batch">
        ...
        <?php if ($published >= 0) : ?>
            ...
            <div id="batch-choose-action" class="k-form-group">
                ...
                <div id="batch-move-copy" class="k-form-group radio">
	...
	<div class="modal-footer">
		<button class="k-button k-button--default" type="button" onclick="document.getElementById('batch-position-id').value='';document.getElementById('batch-access').value='';document.getElementById('batch-language-id').value=''" data-dismiss="modal">
			<?php echo JText::_('JCANCEL'); ?>
		</button>
		<button class="k-button k-button--success" type="submit" onclick="Joomla.submitbutton('module.batch');">
