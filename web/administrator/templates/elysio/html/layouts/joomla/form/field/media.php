...
$attr .= !empty($class) ? ' class="k-form-control field-media-input ' . $class . '"' : ' class="k-form-control"';
...
if ($showPreview)
{
	...
	if ($showAsTooltip)
	{
		echo '<div class="media-preview k-input-group__addon">';
		$tooltip = $previewImgEmpty . $previewImg;
		$options = array(
			'title' => JText::_('JLIB_FORM_MEDIA_PREVIEW_SELECTED_IMAGE'),
					'text' => '<i class="k-icon-eye"></i>',
					'class' => 'hasTipPreview'
					);
	...
	{
		echo '<div class="media-preview k-input-group__addon" style="height:auto">';
...
<a class="modal k-button k-button--default" title="<?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?>" href="
<?php echo ($readonly ? ''
		: ($link ? $link
		: 'index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=' . $asset . '&amp;author='
	. $authorField) . '&amp;fieldid=' . $id . '&amp;folder=' . $folder) . '"'
	. ' rel="{handler: \'iframe\', size: {x: 800, y: 500}}"'; ?>>
 <?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?></a><a class="k-button k-button--default hasTooltip" title="<?php echo JText::_('JLIB_FORM_BUTTON_CLEAR'); ?>" href="#" onclick="jInsertFieldValue('', '<?php echo $id; ?>'); return false;">
    <i class="k-icon-x"></i></a></div>
