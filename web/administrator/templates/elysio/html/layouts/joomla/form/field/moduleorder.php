...
echo $element; ?>" data-client-id="<?php echo $clientId; ?>" data-name="<?php echo $name; ?>" data-attr="<?php echo $attr; ?>">
    @TODO: this works with Chosen only (see media/dystem/moduleorder.js). We need to rewrite this
</div>
