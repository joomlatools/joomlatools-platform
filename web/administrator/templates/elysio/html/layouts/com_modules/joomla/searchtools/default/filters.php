...
<?php if (count($filters) > 1) : ?>
    <div class="k-dynamic-content-holder">
        <div class="k-js-filters">
            <?php if ($data['view'] instanceof ModulesViewModules && JFactory::getApplication()->input->get('layout', '', 'cmd') !== 'modal') :?>
                <?php $clientIdField = $data['view']->filterForm->getField('client_id'); ?>
                <?php var_dump($clientIdField); ?>
                <div data-filter data-title="<?php echo JText::_('TPL_ELYSIO_CLIENT'); ?>">
