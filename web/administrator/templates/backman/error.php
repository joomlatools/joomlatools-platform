...
$doc->setMetaData('apple-mobile-web-app-title', 'Backman');
...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Backman" />
    <meta name="generator" content="Joomla Platform" />
    <title>Error</title>
    <link href="templates/backman/images/favicon.ico" rel="shortcut icon" type="image/ico" />
    <link href="templates/backman/images/favicon.png" rel="shortcut icon" type="image/png" />
    <link href="templates/backman/images/xtouch-icon.png" rel="apple-touch-icon" type="image/png" />
    <link rel="stylesheet" href="templates/backman/css/admin.css" type="text/css" />
    <script src="media/jui/js/jquery.js" type="text/javascript"></script>
    <script src="media/jui/js/jquery-noconflict.js" type="text/javascript"></script>
    <script src="media/jui/js/jquery-migrate.js" type="text/javascript"></script>
    <script src="templates/backman/js/modernizr.js" type="text/javascript"></script>
    <script src="templates/backman/js/admin.js" type="text/javascript"></script>
</head>
